...
game.import("card", function () {
	return {
		...
		translate: {
			...
			renwang_skill_info: "Tỏa định kỹ, 【Sát】 màu đen đối với bạn vô hiệu.",
			sha_info: "Giai đoạn ra bài, sử dụng đối với một nhân vật trong tầm tấn công của bạn. Người đó phải sử dụng một lá 【Thiểm】, nếu không bạn sẽ gây cho người đó 1 điểm sát thương.",
			shan_info: "Triệt tiêu một lá 【Sát】.",
			tao_info: "① Giai đoạn ra bài, sử dụng lên bản thân, nhân vật mục tiêu hồi 1 điểm thể lực. ② Khi có nhân vật trong trạng thái gần chết, sử dụng lên nhân vật đó. Nhân vật mục tiêu hồi 1 điểm thể lực.",
			bagua_info: "Khi bạn cần sử dụng hoặc đánh ra một lá 【Thiểm】, bạn có thể tiến hành phán định. Nếu kết quả là màu đỏ, bạn được xem như đã sử dụng hoặc đánh ra một lá 【Thiểm】.",
			bagua_skill_info: "Khi bạn cần sử dụng hoặc đánh ra một lá 【Thiểm】, bạn có thể tiến hành phán định. Nếu kết quả là màu đỏ, bạn được xem như đã sử dụng hoặc đánh ra một lá 【Thiểm】.",
			jueying_info: "Tỏa định kỹ, các nhân vật khác tính khoảng cách đến bạn +1.",
			get jueying_append() {
				if (get.mode() == "doudizhu") {
